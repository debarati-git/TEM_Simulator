...
## Module 02 — The Microscope (Phase 2, active)
...
## Module 03 — Diffraction Lab (Phase 4, scaffolded)

Diffraction patterns in the lab are rendered mathematically from the crystal
lattice data (`data/crystal-systems.json`) — no static images needed for the
patterns themselves. Reference images are useful for educational comparison.
